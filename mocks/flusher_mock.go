...
// Source: github.com/ozonva/ova-place-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Place) []models.Place {
	m.ctrl.T.Helper()
