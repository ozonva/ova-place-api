...
// Source: github.com/ozonva/ova-place-api/internal/repo (interfaces: Repo)
...
func (m *MockRepo) AddEntities(arg0 context.Context, arg1 []models.Place) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) AddEntity(arg0 context.Context, arg1 models.Place) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 context.Context, arg1 uint64) (*models.Place, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0 context.Context, arg1, arg2 uint64) ([]models.Place, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) TotalCount(arg0 context.Context) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TotalCount", arg0)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepoMockRecorder) TotalCount(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TotalCount", reflect.TypeOf((*MockRepo)(nil).TotalCount), arg0)
}

// UpdateEntity mocks base method.
func (m *MockRepo) UpdateEntity(arg0 context.Context, arg1 uint64, arg2 models.Place) error {
	m.ctrl.T.Helper()
...
func (mr *MockRepoMockRecorder) UpdateEntity(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEntity", reflect.TypeOf((*MockRepo)(nil).UpdateEntity), arg0, arg1, arg2)
}
