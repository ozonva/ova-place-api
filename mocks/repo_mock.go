...
func (m *MockRepo) AddEntities(arg0 []models.Place) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) AddEntity(arg0 models.Place) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*models.Place, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]models.Place, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) UpdateEntity(arg0 uint64, arg1 models.Place) error {
	m.ctrl.T.Helper()
